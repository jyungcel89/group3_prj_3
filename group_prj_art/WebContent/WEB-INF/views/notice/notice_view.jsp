						...
						<div id="view_table_div">
							<table id="view_table">
								<tr>
									...
									<td><c:out value='${readOne.title}'/></td>
								</tr>
								<tr>
									<td style="font-weight: bold; font-size: 18px;">작성일</td>
									<td><c:out value='${readOne.w_date}'/></td>
								</tr>
							</table>
						</div>
						<div id="content_bg">
							<div id="text_area">
								<span id="content"><c:out value='${readOne.content}'/></span>
							</div>
						</div>
						<a href="notice.do"><input id="btn_update" type="button" value="목록으로"/></a>
					</div>
